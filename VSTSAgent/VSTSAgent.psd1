#
# Module manifest for module 'PSGet_VSTSAgent'
#
...
FunctionsToExport = 'Find-VSTSAgent', 'Install-VSTSAgent', 'Get-VSTSAgent', 
               'Uninstall-VSTSAgent', 'Start-VSTSAgent', 'Stop-VSTSAgent'
